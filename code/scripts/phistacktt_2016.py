...
hist(maxmix,tree,"jdphi","dphi1",RF,bins,-4,4,"dphi/ggH125_050","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=2,cuts=Cuts+"*12.9*1000")
hist(pc,tree,"jdphi","dphi1",RF,bins,-4,4,"dphi/ggH125_100","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")


hist(qqH,tree,"jdphi","dphi1",RF,bins,-4,4,"dphi/qqH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=1,cuts=Cuts+"*12.9*1141")
hist(WH,tree,"jdphi","dphi1",RF,bins,-4,4,"dphi/WH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=7,cuts=Cuts+"*12.9*1606")
hist(ZH,tree,"jdphi","dphi1",RF,bins,-4,4,"dphi/ZH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=8,cuts=Cuts+"*12.9*2411")
...
List=["dphi/QCD","dphi/WJ","dphi/TTJ","dphi/ZTT","dphi/ZLL","dphi/qqH125","dphi/WH125","dphi/ZH125"]
...
stackedhist(RF,RF2,"phistacked",List,LegendList,Signallistsm,smlegend,data=Data,datalegend=Datalegend,title="phitt_stacked",xtitle="delta_phi",maximum=150, savename="dphitt_2016sm.png")

stackedhist(RF,RF2,"phistacked",List,LegendList,Signallistmm,mmlegend,data=Data,datalegend=Datalegend,title="phitt_stacked",xtitle="delta_phi",maximum=150, savename="dphitt_2016mm.png")

stackedhist(RF,RF2,"phistacked",List,LegendList,Signallistpc,pclegend,data=Data,datalegend=Datalegend,title="phitt_stacked",xtitle="delta_phi",maximum=150, savename="dphitt_2016pc.png")
