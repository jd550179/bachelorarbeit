...
#Cuts="(mt_1<40.0) *((q_1*q_2)<0.0) *(againstElectronVLooseMVA6_2 > 0.5) *(againstMuonTight3_2 > 0.5) *(extraelec_veto < 0.5)*(extramuon_veto < 0.5) *(dilepton_veto < 0.5) *(iso_1 < 0.15) *(byTightIsolationMVArun2v1DBoldDMwLT_2 > 0.5) *(jdphi>-900) *eventWeight *((log((sqrt(jm_1*jm_1+jpt_1*cosh(jeta_1)*jpt_1*cosh(jeta_1))+jpt_1*sinh(jeta_1))/sqrt(jm_1*jm_1+jpt_1*jpt_1))*log((sqrt(jm_2*jm_2+jpt_2*cosh(jeta_2)*jpt_2*cosh(jeta_2))+jpt_2*sinh(jeta_2))/sqrt(jm_2*jm_2+jpt_2*jpt_2)))<0)"
...
hist(DY,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/ZTT","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=797,linecolor=1,cuts= Cuts+"*12.9*1000 *(gen_match_2 == 5)")
hist(DY,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/ZLL","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=860,linecolor=1,cuts= Cuts+"*12.9*1000 *(gen_match_2 < 5 || gen_match_2 == 6)")

hist(WJets,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/WJ","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=892,linecolor=1,cuts= Cuts+"*12.9*1000")
hist(tt,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/TTJ","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=592,linecolor=1,cuts=Cuts+"*12.9*1000")
#hist(Diboson,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/VV","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=432,linecolor=1,cuts= Cuts+"*12.9*1000")
hist(Data,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/QCD","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=820,linecolor=1,cuts= Cuts.replace("(q_1*q_2)<0.0)", "(q_1*q_2)>0.0)"))
hist(Data,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/data_obs","E0",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=1,cuts= Cuts)


hist(sm,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/ggH125_000","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=798,cuts=Cuts+"*12.9*1000*1141")
hist(maxmix,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/ggH125_050","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=2,cuts=Cuts+"*12.9*1000*1606")
hist(pc,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/ggH125_100","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000*2411")


hist(qqH,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/qqH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(WH,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/WH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(ZH,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/ZH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")

hist(ggH,tree,"jdphi","dphi1",RF,20,-4,4,"dphi/ggH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
...
hist(qqH,tree,"sin(fabs(jdphi)/2)","dphi1",RF,10,0,1,"sin_dphi/qqH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(WH,tree,"jdphi","sin(fabs(jdphi)/2)",RF,10,0,1,"sin_dphi/WH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(ZH,tree,"jdphi","sin(fabs(jdphi)/2)",RF,10,0,1,"sin_dphi/ZH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
...
hist(WH,tree,"jpt_1","pt_1",RF,50,0,500,"pt_1/WH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(qqH,tree,"jpt_1","pt_1",RF,50,0,500,"pt_1/qqH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
...
hist(WH,tree,"jpt_2","pt_2",RF,50,0,500,"pt_2/WH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(qqH,tree,"jpt_2","pt_2",RF,50,0,500,"pt_2/qqH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
...
hist(WH,tree,"dijetphi","dijetphi",RF,40,-4,4,"dijet/WH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(qqH,tree,"dijetphi","dijetphi",RF,40,-4,4,"dijet/qqH125","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
hist(sm,tree,"dijetphi","dijetphi",RF,40,-4,4,"dijet/ggH125_000","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000*1141")
hist(maxmix,tree,"dijetphi","dijetphi",RF,40,-4,4,"dijet/ggH125_050","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000*1606")
hist(pc,tree,"dijetphi","dijetphi",RF,40,-4,4,"dijet/ggH125_100","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000*2411")



hist(sm,tree,"jphi_1","dphi1",RF,40,-4,4,"phi1/ggH125_000","HIST",Dir="mt_jecUncNom_tauEsNom", fillcolor=0,linecolor=798,cuts=Cuts+"*12.9*1000*1141")




#sqrt(jm_1*jm_1+jpt_1*Cosh(jeta_1)*jpt_1*Cosh(jeta_1))



hist(sm,tree,"log((sqrt(jm_1*jm_1+jpt_1*cosh(jeta_1)*jpt_1*cosh(jeta_1))+jpt_1*sinh(jeta_1))/sqrt(jm_1*jm_1+jpt_1*jpt_1))-log((sqrt(jm_2*jm_2+jpt_2*cosh(jeta_2)*jpt_2*cosh(jeta_2))+jpt_2*sinh(jeta_2))/sqrt(jm_2*jm_2+jpt_2*jpt_2))","deta",RF,40,-10,10,"pseudorapidity/ggH125_000","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000*1141")

hist(maxmix,tree,"log((sqrt(jm_1*jm_1+jpt_1*cosh(jeta_1)*jpt_1*cosh(jeta_1))+jpt_1*sinh(jeta_1))/sqrt(jm_1*jm_1+jpt_1*jpt_1))-log((sqrt(jm_2*jm_2+jpt_2*cosh(jeta_2)*jpt_2*cosh(jeta_2))+jpt_2*sinh(jeta_2))/sqrt(jm_2*jm_2+jpt_2*jpt_2))","deta",RF,40,-10,10,"pseudorapidity/ggH125_050","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000*1606")

hist(pc,tree,"log((sqrt(jm_1*jm_1+jpt_1*cosh(jeta_1)*jpt_1*cosh(jeta_1))+jpt_1*sinh(jeta_1))/sqrt(jm_1*jm_1+jpt_1*jpt_1))-log((sqrt(jm_2*jm_2+jpt_2*cosh(jeta_2)*jpt_2*cosh(jeta_2))+jpt_2*sinh(jeta_2))/sqrt(jm_2*jm_2+jpt_2*jpt_2))","deta",RF,40,-10,10,"pseudorapidity/ggH125_100","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000*2411")

hist(qqH,tree,"log((sqrt(jm_1*jm_1+jpt_1*cosh(jeta_1)*jpt_1*cosh(jeta_1))+jpt_1*sinh(jeta_1))/sqrt(jm_1*jm_1+jpt_1*jpt_1))-log((sqrt(jm_2*jm_2+jpt_2*cosh(jeta_2)*jpt_2*cosh(jeta_2))+jpt_2*sinh(jeta_2))/sqrt(jm_2*jm_2+jpt_2*jpt_2))","deta",RF,40,-10,10,"pseudorapidity/qqH125","HIST",Dir="tt_jecUncNom_tauEsNom", fillcolor=0,linecolor=4,cuts=Cuts+"*12.9*1000")
...
stackedhist(RF,RF2,"phistacked",List,LegendList,Signallistsm,smlegend,data=Data,datalegend=Datalegend,title="phi_stacked",xtitle="delta_phi",maximum=600, savename="dphi_2016sm.png")

stackedhist(RF,RF2,"phistacked",List,LegendList,Signallistmm,mmlegend,data=Data,datalegend=Datalegend,title="phi_stacked",xtitle="delta_phi",maximum=600, savename="dphi_2016mm.png")

stackedhist(RF,RF2,"phistacked",List,LegendList,Signallistpc,pclegend,data=Data,datalegend=Datalegend,title="phi_stacked",xtitle="delta_phi",maximum=600, savename="dphi_2016pc.png")
